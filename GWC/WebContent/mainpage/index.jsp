          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            ...
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                ...
                <dd>
	              <a href="/GWH/mainpage/index.jsp" lay-tips="退出登陆" lay-direction="2">
	                <cite>退出登陆</cite>
	              </a>
                </dd>
              </dl>
            ...
            <li data-name="set" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd>
                  <a lay-href="/GWC/lookup/index.jsp" lay-tips="图书查询">图书查询</a>
                </dd>
                <dd>
            ...
            <li data-name="set" class="layui-nav-item">
              <a lay-href="/GWC/ShoppingCart/ShoppingCart.jsp" lay-tips="购物车" lay-direction="2">
            ...
            <li data-name="set" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd>
                  <a lay-href="/GWC/WebContent/order/MakeOrderForm.jsp" lay-tips="确认订单">
                  	确认订单
                  </a>
                </dd>
                <dd>
                  <a lay-href="/GWC/WebContent/order/PreviewOrderForm.jsp" lay-tips="订单预览">订单预览</a>
                </dd>
              </dl>
            </li>
          ...
          <ul class="layui-nav layadmin-tabs-select" lay-filter="layadmin-pagetabs-nav">
            <li class="layui-nav-item" lay-unselect>
              ...
              <dl class="layui-nav-child layui-anim-fadein">
                <dd layadmin-event="closeThisTabs"><a href="javascript:;">关闭当前页面</a></dd>
                <dd layadmin-event="closeOtherTabs"><a href="javascript:;">关闭其他页面</a></dd>
                <dd layadmin-event="closeAllTabs"><a href="javascript:;">关闭全部页面</a></dd>
              </dl>
            </li>
          </ul>
        </div>
